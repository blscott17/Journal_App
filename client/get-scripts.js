  ...
  fetch('http://localhost:3000/journal/mine', {
    ...
    .then(function (response) {
      ...
      if (response.length === 0) {
        ...
        header.textContent = "You havent't made any posts yet!";
        ...
        for (i = 0; i < response.length; i++) {
          ...
          subtitle.setAttribute('class', 'card-substitute mb-2 text-muted');
 ...
 *** DISPLAY ALL ***
 ************************** */
// Removed const accessToken after fetch and Authorization: accessToken after
// Content-type.
// const accessToken = localStorage.getItem('SessionToken');
//       Authorization: accessToken,
function displayAll() {
...
// Also removed edit and delete buttons from each journal entry
/* *************************
 *** DISPLAY BY TITLE ***
 ************************** */
